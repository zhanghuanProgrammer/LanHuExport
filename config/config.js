...
const Develop_Lan_define = 5;//语言-define
...
const DevelopDone_Lan_define = true;//语言-define 是否适配完
...
const Code_template = "code_template";//代码模板
function Save_Code_template() {return Code_template + cur_lan;}
